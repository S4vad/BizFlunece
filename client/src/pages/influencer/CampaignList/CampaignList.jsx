        ...
        {selectedCampaign && (
          <div className="relative flex h-full flex-col justify-start">
            <div className="absolute right-3 top-3">
              <button className="group relative flex h-[1.8rem] cursor-pointer items-center overflow-hidden rounded-[0.6rem] bg-[#4b48ff] px-2 py-[0.35em] pl-5 text-[14px] font-medium text-white shadow-[inset_0_0_1.6em_-0.6em_#714da6]">
