      ...
      <div className="flex items-center justify-center space-x-10 py-20">
        {influencerNiche.map((niche, index) => (
          <div
            ...
            className={`text-lg cursor-pointer rounded-full border border-indigo-600 px-4 py-4 text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all duration-300
            ${selectedNiche === niche ? "bg-indigo-600 text-white" : "text-indigo-600 hover:text-white"}`}
            key={index}
          >
            {niche}
          </div>
